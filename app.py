...
# Obtener datos
df_temp = get_data(query_temperature)
...
if df_temp is not None and not df_temp.empty:
    ...
    # Renombrar columnas
    df_temp.columns = ["Tiempo", "Temperatura"]

    # Convertir tiempo a datetime
    df_temp["Tiempo"] = pd.to_datetime(df_temp["Tiempo"])
    ...
    st.warning("No se encontraron datos de temperatura.")
